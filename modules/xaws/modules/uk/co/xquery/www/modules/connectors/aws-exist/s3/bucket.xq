...
declare function bucket:list(
    ...
    bucket:list($aws-access-key,$aws-secret,$bucket,'','','1000','')
};
...
(:~
 ...
 : @param $max-keys the maximum number of keys returned (default: "1000"). If more keys than $max-keys can be fetched, the 
...
declare function bucket:list(
    ...
    let $parameters := 
        (
            ...
            if($max-keys) then <parameter name="max-keys" value="{$max-keys}" /> else (),
