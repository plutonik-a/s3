...
(:~
 ...
 :)
module namespace request = 'http://www.xquery.co.uk/modules/connectors/aws/helpers/request';

import module namespace util = 'http://www.xquery.co.uk/modules/connectors/aws/helpers/utils' at 'utils.xq';
...
(:~
 ...
 : @return the newly created http request
:)
declare function request:create($method as xs:string,$href as xs:string,$parameters as element(parameter)*) as element(http:request) {
